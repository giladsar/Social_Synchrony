...
\subsubsection{Dyadic Co-Crossing (Approach Synchrony)}
Figure~\ref{fig:head_traj} shows the spatial trajectories of each individual's head centroid across the full recording. Person 1 (left panel) exhibits a wider lateral range of motion compared to Person 2 (right panel).
