...
\begin{enumerate}
    ...
    \item Lin, T. Y., Maire, M., Belongie, S., et al. (2014). Microsoft COCO: Common Objects in Context. \textit{European Conference on Computer Vision (ECCV)}, 740-755.
    ...
    \item Farnebäck, G. (2003). Two-Frame Motion Estimation Based on Polynomial Expansion. \textit{Scandinavian Conference on Image Analysis}, 363-370.
\end{enumerate}
